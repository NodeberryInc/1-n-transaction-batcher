...
/**
 * The smart contract is used for research purpose and is not audited for production.
 * We strongly recommend you to audit the contract before using it.
 * 1-N batchers will send to n address with minimal gas.
 * Tokens should've to be sent to the contract before sending.
 */
...
contract Batcher is ReentrancyGuard, IBatcher {
     ...
     * _transferValue - amount of tokens to be batched.
     * _transferValue is decimal sensitive
     */

    constructor(address _tokenContract, uint256 _transferValue) {
